          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            >
              <Card className="border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-white rounded-xl overflow-hidden">
                {/* Cover Photo */}
                <div className="h-28 md:h-36 bg-gradient-to-r from-cyan-400 via-yellow-400 to-pink-400 relative border-b-2 border-black">
                  ...
                  <div className="p-4 md:p-6">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 flex-1">
                        {/* Profile Image */}
                        <div className="relative mx-auto sm:mx-0 -mt-12 md:-mt-16">
                          <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full border-4 border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center relative z-10 overflow-hidden">
                          ...
                          <Button
                            size="sm"
                            className="absolute -bottom-0.5 -right-0.5 w-7 h-7 md:w-8 md:h-8 rounded-full p-0 bg-yellow-400 border-2 border-black hover:bg-yellow-500 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 z-20"
                            ...
                            <div className="space-y-4">
                              ...
                              {user.bio && (
                                <div className="bg-cyan-400 p-4 rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                                  <span className="font-black text-black uppercase text-xs block mb-2">
                                    Bio
                                  </span>
                  ...
                  <div className="border-t-2 border-black bg-gray-50 p-4 md:p-6">
                    <div className="grid grid-cols-3 gap-4">
                      <div className="bg-yellow-400 p-4 md:p-6 rounded-xl border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
                        ...
                        <p className="text-black font-bold text-xs md:text-sm uppercase">
                          Postingan
                        </p>
                      </div>
                      ...
                      <div className="bg-green-400 p-4 md:p-6 rounded-xl border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
                        ...
                        <p className="text-2xl md:text-3xl font-black text-black">
                          {Math.round(
                            (userStats.posts /
                              Math.max(userStats.totalPosts, 1)) *
                              100,
                          ) || 0}
                          %
                        </p>

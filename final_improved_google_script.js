/**
 * Google Apps Script untuk Mahasiswa Feedback Platform - FINAL IMPROVED VERSION
...
function handleUpdatePost(e) {
  try {
    ...
    Logger.log("Update post request: " + postId + " by user: " + userId);
      ...
      if (data[i][0] === postId) {
        ...
        if (postOwner === userId) {
          ...
          if (updateData.judul !== undefined) {
            postingSheet.getRange(i + 1, 3).setValue(updateData.judul);
          }
          if (updateData.deskripsi !== undefined) {
            postingSheet.getRange(i + 1, 4).setValue(updateData.deskripsi);
          }
...
function handleDeletePost(e) {
  try {
    ...
    Logger.log("Delete post request: " + postId + " by user: " + userId);
    ...
    for (var i = 1; i < data.length; i++) {
      if (data[i][0] === postId) {
        ...
        Logger.log("Post owner: " + postOwner + ", Requesting user: " + userId + ", User role: " + userRole);
